...
namespace MyProject.Tests
{
    ...
    public class TaxiServiceTests
    {
        ...
        [TestMethod]
        [Timeout(3000)]
        public void CreateRide_ShouldCompleteWithinTimeout()
        {
            var ride = taxiService.CreateRide("Timeout Test", "+375290000000", "Point A", "Point B", 2m);
            Assert.IsNotNull(ride);
            Assert.AreEqual(RideStatus.Pending, ride.Status);
        }
        ...
        [TestMethod]
        [Timeout(1000)]
        public void SlowTest_ShouldBeTerminatedByTimeout()
        {
            System.Threading.Thread.Sleep(5000);
            Assert.Fail("This line should not be reached — timeout should have killed the test");
        }
    }
}
